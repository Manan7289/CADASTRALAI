"""LEGACY (pre-finale) demo server, kept from main so the Vercel demo pages keep working.
The finale app is backend/app.py; run this one only for the old static demo + its upload
pipeline, and use frontend/upload-legacy.html as its upload page.
